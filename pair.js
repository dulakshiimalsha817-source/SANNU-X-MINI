...
const config = {
    ...
    RCD_IMAGE_PATH: './sannubot.jpg',
    NEWSLETTER_JID: '120363405600029703@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '9477256l3976',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb6szVQCsU9UjD976t14'
};

const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'dinubinu23-oss';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'SANNU-X-MINI-BOT-V1#';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '🍂 𝐂𝙾𝙽𝙽𝙴𝙲𝚃 𝐒𝙰𝙽𝙽𝚄 𝚇  𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 🪔',
        `📞 Number: ${number}\n🩵 Status: Connected`,
        '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳'
    );
...
`;
        ...
        },
        {
            ...
            nativeFlowInfo: {
                ...
                paramsJson: JSON.stringify({
                    ...
                    sections: [
                        {
                            title: ` 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃`,
                            highlight_label: '',
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: '𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈  𝐒𝙰𝙽𝙽𝚄 𝚇  𝐌𝙳',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/r5ohrj.jpg" },
        caption: ` 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/r5ohrj.jpg" },
        caption: ` 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐋𝙸𝚂𝚃 𝐌𝙴𝙽𝚄\n\n${captionText}`,
    }, { quoted: msg });
    ...
    const ownerName = '𝙳𝙰𝚁𝙺 𝙺𝙸𝙽𝙶 𝚆𝙸𝚃𝙷𝙴 𝚂𝙰𝙽𝙽𝚄 𝚇';
    const organization = '*𝐒𝐀𝐍𝐍𝐔 𝐗-𝐌𝐃* WHATSAPP BOT DEVALOPER 🍬';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*SANNU X-MD OWNER*\n\n👤 Name: ${ownerName}\n📞 Number: ${ownerNumber}\n\n> 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈  𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳`,
            contextInfo: {
  ...
  break;
       ...
       case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363405600029703@newsletter'
                        });
                    }
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> * 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
    ...
    break;
                ...
                case 'ai': {
                    ...
                    if (!q || q.trim() === '') {
                        return await socket.sendMessage(sender, { text: "ඕ කියන්න අනේ් මම  𝐒𝙰𝙽𝙽𝚄 𝚇  AI 🤭" }, { quoted: msg });
                    }

                    const prompt = `ඔබගේ නම  𝐒𝙰𝙽𝙽𝚄 𝚇 𝙰𝙸.  
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                            '👻 𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾  𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻',
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻  𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 is running',
